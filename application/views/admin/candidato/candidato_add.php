...
<div class="row">
    <?= form_open('admin_home/valid_user/candidato', 'class="form_admin"');?>
    <?
...
<div class="row" id="edit_form">
    ...
    <?= form_open('admin_home/valid_user/candidato', 'class="form_admin edit_user_form"');?>
        <fieldset>
          ...
          <table class="table table-hover panel">
            ...
            <? foreach ($users_event->result() as $x ) { ?>
                <tr>
                  ...
                  <a href="<?= site_Url(); ?>/admin_home/valid_user/candidato/<?= $x->user_event_id ?>" class="btn btn-danger btn-xs confirmar">Confirmar borrado</a>
                  </td>
